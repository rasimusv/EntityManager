...
public class EntityManager {
    ...
    public static <T> void createTable(String tableName, Class<T> entityClass) {
    ...
    public static void save(String tableName, Object entity) {
    ...
    public static <T, ID> void findById(String tableName, Class<T> resultType, Class<ID> idType, ID idValue) {
